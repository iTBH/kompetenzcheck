...
<div class="unique-{{$unique}}">
    ...
    <div class="phrase">
        ...
        <a href="javascript:void(0)" data-unique="{{$unique}}" class="assessment-edit-btn ui small icon button" style="float: right; margin-top: -8px;" ><i class="edit icon"></i></a>
        <a href="javascript:void(0)" class="assessment-delete-btn ui small icon button" style="float: right; margin-top: -8px;"><i class="remove icon"></i></a>
    </div>
</div>